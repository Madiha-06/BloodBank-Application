...
public class DonorForm extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel5.setText("Date of Last Donation");
    ...
    try (Connection conn = DriverManager.getConnection("jdbc:ucanaccess://C:/Users/USER/Documents/bloodbank.accdb")) {
        String query = "INSERT INTO [donor details] ([Donor ID], Name, Num, [Blood Type], [Last donation date]) VALUES (?, ?, ?, ?, ?)";
        try (PreparedStatement pst = conn.prepareStatement(query)) {
            pst.setString(1, donor.getdonorid());
            pst.setString(2, donor.name);
            pst.setLong(3, donor.num);
            pst.setString(4, donor.getbloodtype());
